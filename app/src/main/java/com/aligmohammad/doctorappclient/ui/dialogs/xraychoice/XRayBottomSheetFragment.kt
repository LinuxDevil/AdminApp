...
package com.aligmohammad.doctorappclient.ui.dialogs.xraychoice
...
import com.aligmohammad.doctorappclient.databinding.XRayBottomSheetFragmentBinding
...
import kotlinx.android.synthetic.main.x_ray_bottom_sheet_fragment.view.*
import java.util.*
...
class XRayBottomSheetFragment : BottomSheetDialogFragment(), OnDialogInteract,
    ...
    private lateinit var viewModel: XRayBottomSheetViewModel
    ...
    override fun onCreateView(
        ...
        viewModel = ViewModelProvider(this).get(XRayBottomSheetViewModel::class.java)
    ...
    private fun initializeUI() {
        binding.placeSpinner.adapter = ArrayAdapter(requireContext(), android.R.layout.simple_dropdown_item_1line, places)
    }
            ...
            database.child("Appointments").child(appointmentUuid).setValue(appointment)
                .addOnCompleteListener {
                    ...
                    database.child("Doctors").child(userId!!).child("Appointments")
                        ...
                        database.child("Places").child("X-Rays").child(selectedPlace)
