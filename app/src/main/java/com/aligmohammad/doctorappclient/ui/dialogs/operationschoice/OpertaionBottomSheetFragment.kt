...
package com.aligmohammad.doctorappclient.ui.dialogs.operationschoice
...
import com.aligmohammad.doctorappclient.databinding.OpertaionBottomSheetFragmentBinding
...
class OpertaionBottomSheetFragment : BottomSheetDialogFragment(), OnDialogInteract,
    ...
    private fun getPlaces() {
        ...
        db.child("Places/Operations").addListenerForSingleValueEvent(object : ValueEventListener {
